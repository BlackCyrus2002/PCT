            ...
            while ($artisan = $user->fetch_assoc()) { ?>
                <div class="post photo" data-photo-id="<?php echo $picture['id_photo']; ?>">
                    ...
                    <div class="navbar">
                        ...
                        <a href="https://wa.me/+225<?php echo $artisan['tel_wa']; ?>" target="_blank"><i class="fa-brands fa-whatsapp" id="whatsapp"></i></a>
                        <a href="tel:+225<?php echo $artisan['telephone']; ?>" target="_blank"><i class="fa fa-phone" id="instagram"></i></a>
                    </div>
                    <div><br>
                        <a href="demande_et_service.php?id_artisan=<?php echo $artisan['ID']; ?>&id_photo=<?php echo $picture['id_photo']; ?>" style="text-decoration: none;" class="click-photo">Contacter</a>
                    </div>
                    <form action="" method="post">
                        <div class="comments-section">
                            ...
                            <textarea name="comment" id="comment-input" class="commentaire" placeholder="Commentaire"></textarea>
