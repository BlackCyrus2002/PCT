...
if ($_SESSION['search']) {
    ...
    OR nom LIKE '%$searchs%' OR prenom  LIKE '%$searchs%' ORDER BY nom ASC ";
...
<head>
    ...
    <title>Resultat pour: '<?php echo $searchs ?>' </title>
    <style>
        ul li a {
                ...
                <div class="row">
                    ...
                    ?>
                        <div class="col-xl-3 col-md 6" style="margin-bottom: 20px;">
                            <a href="profil_artisans.php?id_art=<?php echo $fil['ID'] ?>&& nom=<?php echo $fil['nom'] . ' ' . $fil['prenom'] ?>" style="color: black;text-decoration:none">
                                <div class="contact">
                                    <center>
                                        ...
                                        <div style="display: flex;align-items:center">
                                            ...
                                            <div style="padding-top:10px">
                                                <h6 style="font-family: Georgia, 'Times New Roman', Times, serif;font-weight:bold">
                                                    <?php echo $fil['metier'] ?>
                                                </h6>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            <a href="tel:+225<?php echo $fil['telephone'] ?>" class="btn btn-primary" style="box-shadow: 2px 6px 10px rgba(0, 0, 0, 0.247);">
