...
<body>
    ...
    <div style="background-color: rgba(128, 128, 128, 0.2);padding-top:20px">
                    ...
                    <a href="" style="text-decoration: none;color: black;display:block">
                        <div class="contact">
                            <center>
                                ...
                                <h3 style="font-family: Georgia, 'Times New Roman', Times, serif;font-weight:bold">
                                    <?php echo $fil['nom'] . ' ' . $fil['prenom'] ?>
                                </h3>
