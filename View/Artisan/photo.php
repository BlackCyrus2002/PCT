                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="mb-3" hidden>
                            ...
                            <input type="text" class="form-control" name="nom" id="nom" aria-describedby="helpId"
                                placeholder="" value="<?php echo $only_user['ID'] ?>" readonly />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nom" id="nom" aria-describedby="helpId"
                                placeholder="" value="<?php echo $only_user['nom'] . ' ' . $only_user['prenom'] ?>"
                                readonly />
                            <span style="color: red;font-size:18px">
                                <?php
                                echo $nom_error
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="phone_number" id="phone_number"
                                aria-describedby="helpId" placeholder="" value="<?php echo $only_user['telephone'] ?>"
                                readonly />
                            <span style="color: red;font-size:18px">
                            </span>
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="phone_wa" id="phone_wa"
                                aria-describedby="helpId" placeholder="" value="<?php echo $only_user['tel_wa'] ?>"
                                readonly />
                        </div>
                        <div class="mb-3">
                            <label for="email" class="form-label">Email</label>
                            <input type="text" class="form-control" name="email" id="email" aria-describedby="helpId"
                                placeholder="" value="<?php echo $only_user['gmail'] ?>" readonly />
                            <span style="color: red;font-size:18px">
                                <?php
                                echo $email_error
                                ?>
